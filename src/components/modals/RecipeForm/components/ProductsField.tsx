    ...
    <div className={css.productsFieldContainer}>
      <div className={css.header}>
        <div className={css.container}>
          <div className={css.label}>{i18next.t('domain:recipe.recipeProducts')}</div>
          <Button className={css.button} kind="ghost" onClick={props.onNewClick}>
        ...
        {fields
          .map((rp, index) => (
            <div className={css.product} key={rp.product.id}>
              ...
              />
              <div className={css.name} data-tooltip-id={`product-delete${rp.product.id}`}>
